  ...
  return (
    <div className="blog-page-container">
      <div className="blog-post-container">
        <h1 className="blog-title">Building My First Major Web App: Verika Jewelry Store E-commerce Front End</h1>
        
        <div className="blog-content">
          <p className="blog-intro">
            As a web development student, I wanted to tackle a project that would test my front-end skills and mimic a real-world application. I decided to build a mock e-commerce site for a jewelry brand called "Verika."
          </p>
          <p>
